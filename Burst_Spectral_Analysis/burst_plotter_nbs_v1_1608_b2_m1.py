...
if fit_method == '1':
    ...
    axarr[2].set_ylim(-40.0,1840.0)
    axarr[2].set_yticks([200.0,600.0,1000.0,1400.0])
    ...
    axarr[3].set_ylim(0.6,3.0)
    axarr[3].set_yticks([0.5,1.5,2.5])
...
if fit_method == '3':
    ...
    plt.savefig(burst_folder+source_name+'/burst'+bid+'/figure'+source_name+'_b'+bid+'_f'+fit_method+'_'+mine+'_'+maxe+'_new.pdf',orientation='landscape')
    plt.savefig(burst_folder+source_name+'/burst'+bid+'/figure'+source_name+'_b'+bid+'_f'+fit_method+'_'+mine+'_'+maxe+'_new.png',orientation='landscape')
    if not os.path.isdir(burst_folder+source_name+'/plots/'):
        print('No Plots folder found, creating a new one')
        os.makedirs(burst_folder+source_name+'/plots/')
    plt.savefig(burst_folder+source_name+'/plots/figure'+source_name+'_b'+bid+'_f'+fit_method+'_'+mine+'_'+maxe+'_new.pdf',orientation='landscape')
    plt.savefig(burst_folder+source_name+'/plots/figure'+source_name+'_b'+bid+'_f'+fit_method+'_'+mine+'_'+maxe+'_new.png',orientation='landscape')
...
if (fit_method == '2') or (fit_method == '4'):
    ...
    plt.savefig(burst_folder+source_name+'/burst'+bid+'/figure'+source_name+'_b'+bid+'_f'+fit_method+'_new_'+mine+'_'+maxe+'_new.pdf',orientation='landscape')
    plt.savefig(burst_folder+source_name+'/burst'+bid+'/figure'+source_name+'_b'+bid+'_f'+fit_method+'_new_'+mine+'_'+maxe+'_new.png',orientation='landscape')
    if not os.path.isdir(burst_folder+source_name+'/plots/'):
        print('No Plots folder found, creating a new one')
        os.makedirs(burst_folder+source_name+'/plots/')
    plt.savefig(burst_folder+source_name+'/plots/figure'+source_name+'_b'+bid+'_f'+fit_method+'_new_'+mine+'_'+maxe+'_new.pdf',orientation='landscape')
    plt.savefig(burst_folder+source_name+'/plots/figure'+source_name+'_b'+bid+'_f'+fit_method+'_new_'+mine+'_'+maxe+'_new.png',orientation='landscape')
