...
#burst_folder = '/Users/hea/ownCloud/burst_characterization_v3/'
burst_folder ='/home/hea/ownCloud/burst_characterization_v4/'
#sfolder = '/Users/hea/ownCloud/burst_characterization_v3/scripts/'
...
if fit_method == '3':
    ...
    axarr[0].set_ylabel(r'Flux ($\times10^{-9}$)')
    axarr[0].set_ylim(-6.0,340.0)
    #axarr[0].plot([33,33],[0.01,150],linestyle='--',color='Red',lw=2)
    axarr[0].grid(True)
    axarr[0].set_yticks([0.0,100.0,200.0,300.0])
    axarr[0].set_title(r' '+'4U 1606-522 Burst:'+bid)

    axarr[1].errorbar(b_time, BB_kT_l, yerr=BBkT_err,xerr=exp_err,linestyle='None', marker='.', label = 'BB kT',ms=msize, elinewidth=eline,color='Black',)
    axarr[1].set_ylim(0.6,5.8)
    #axarr[1].plot([33,33],[0.0,150],linestyle='--',color='Red',lw=2)
    axarr[1].grid(True)
    axarr[1].set_ylabel(r'kT (keV)')
    ...
    axarr[2].set_yticks([0.0,200.0,600.0,1000.0])
    #axarr[2].set_ylim(min_range_norm-0.1*min_range_norm,max_range_norm+0.1*max_range_norm)
    #axarr[2].set_yscale('log')
