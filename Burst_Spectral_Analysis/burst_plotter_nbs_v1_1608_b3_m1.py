...
if fit_method == '1':
    ...
    axarr[0].set_ylim(-5.0,100.0)
    #axarr[0].set_yticks([1.0,1.2,1.4], fontsize=12) ----yapıcaksın!!!!
    axarr[0].plot([33,33],[0.01,150],linestyle='--',color='Red',lw=2) #--for red line
    ...
    axarr[2].set_yticks([0.0,150.0,350.0,550.0])
    axarr[2].plot([33,33],[0.01,1350],linestyle='--',color='Red',lw=2)
    ...
    axarr[3].plot([33,33],[0.01,5],linestyle='--',color='Red',lw=2)
    axarr[3].set_xlabel('Time (s)')  
    axarr[3].grid(True)
  
    plt.xlim(0.7,max_time)
...
if fit_method == '3':
    ...
    axarr[0].plot([33,33],[0.01,150],linestyle='--',color='Red',lw=2)
    ...
    #axarr[2].set_ylim(min_range_norm-0.1*min_range_norm,max_range_norm+0.1*max_range_norm)
    #axarr[2].set_yscale('log')
    axarr[2].plot([33,33],[0.01,1150],linestyle='--',color='Red',lw=2)
    axarr[2].set_ylabel(r'Norm (R$^2$/D$_{10kpc})$' )
    ...
    axarr[4].plot([33,33],[0.01,5],linestyle='--',color='Red',lw=2 )
