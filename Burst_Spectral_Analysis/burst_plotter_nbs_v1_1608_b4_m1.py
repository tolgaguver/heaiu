c# this code will plot the results of time resolved spectral analysis of X-ray bursts :
...
if fit_method == '1':
    ...
    axarr[0].grid(True)
    axarr[0].set_yticks([0.0,25.0,50.0,75.0,100.0])
    ...
    axarr[2].set_ylim(-75.0,850.0)
    axarr[2].set_yticks([0.0,250.0,450.0,650.0])
