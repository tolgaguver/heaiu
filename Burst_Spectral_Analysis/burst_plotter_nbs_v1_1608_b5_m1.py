...
if fit_method == '1':
    ...
    axarr[1].set_yticks([0.5,1.5,2.5])
...
if (fit_method == '2') or (fit_method == '4'):
    ...
    plt.savefig(burst_folder+source_name+'/burst'+bid+'/figure'+source_name+'_b'+bid+'_f'+fit_method+'_new'+mine+'_'+maxe+'.pdf',orientation='landscape')
    plt.savefig(burst_folder+source_name+'/burst'+bid+'/figure'+source_name+'_b'+bid+'_f'+fit_method+'_new'+mine+'_'+maxe+'.png',orientation='landscape')
    if not os.path.isdir(burst_folder+source_name+'/plots/'):
        print('No Plots folder found, creating a new one')
        os.makedirs(burst_folder+source_name+'/plots/')
