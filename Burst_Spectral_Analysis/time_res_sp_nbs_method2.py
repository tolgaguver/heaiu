...
for i in range(len(sp_list)-1):
        ...
        if (initial_rstat < (spers_rstat.values[0]+3.50)/spers_dof.values[0]):
                ...
                if (None in cparmins) == True or (None in cparmaxes) == True or (0 in cparmaxes) == True or (0 in cparmins) == True:
                        ...
                        print('It seems like you have unconstrained parameters therefore we cant calculate the errors')
                ...
                print('This is 2=thawed background and one free BB')
                ...
                if (None in cparmins) == True or (None in cparmaxes) == True or (0 in cparmaxes) == True or (0 in cparmins) == True:
                        ...
                        if is_all_zero: 
                                ...
                                sample2=sample_flux(dbb,0.5,10.0, num=100, correlated=True,confidence=68,scales=matrix)
                                dbb_flux_l.append(sample2[1][0]) 
                                max_dbbflux_l.append(sample2[1][1]-sample2[1][0])
                                min_dbbflux_l.append(sample2[1][0]-sample2[1][2])
                                sample3=sample_flux(sbb,0.5,10.0, num=100, correlated=True,confidence=68,scales=matrix)
                                sBB_flux_l.append(sample3[1][0]) 
                                max_sBBflux_l.append(sample3[1][1]-sample3[1][0])
                                min_sBBflux_l.append(sample3[1][0]-sample3[1][2])
                                # Parameter errors will be written as they are :
                                ...
                                dbb_kT_l.append(get_covar_results().parvals[2])
                                min_dbbkT_l.append(get_covar_results().parmins[2])
                                max_dbbkT_l.append(get_covar_results().parmaxes[2])
                                dbb_Norm_l.append(get_covar_results().parvals[3])
                                min_dbbNorm_l.append(get_covar_results().parmins[3])
                                max_dbbNorm_l.append(get_covar_results().parmaxes[3])
                                sBB_kT_l.append(get_covar_results().parvals[4])
                                min_sBBkT_l.append(get_covar_results().parmins[4])
                                max_sBBkt_l.append(get_covar_results().parmaxes[4])
                                sBB_Norm_l.append(get_covar_results().parvals[5])
                                min_sBBNorm_l.append(get_covar_results().parmins[5])
                                max_sBBNorm_l.append(get_covar_results().parmaxes[5])
                                ...
                                max_fa_l.append(0)
                                # Parameter Errors will be written as 0:
                                BB2_kT_l.append(get_covar_results().parvals[0])
                                min_2BBkT_l.append(0)
                                max_2BBkt_l.append(0)
                                BB2_Norm_l.append(get_covar_results().parvals[1])
                                min_2BBNorm_l.append(0)
                                max_2BBNorm_l.append(0)
                                BB2_flux_l.append(get_covar_results().parvals[2])
                                min_2BBflux_l.append(0)
                                max_2BBflux_l.append(0)
                                BB2_2BBF_l.append(get_covar_results().parvals[3])
                                min_2BolBBF_l.append(0)
                                max_2BolBBF_l.append(0)
